...
def load_GPS_EXIF(fname):
    ...
    with open(fname, "rb") as fobj:
        ...
        # Check that there is a GPS ...
        if "GPS GPSStatus" in tags:
            ...
            if tags["GPS GPSStatus"].values[0] == "A":
                ...
                if "GPS GPSDOP" in tags:
                    ...
                    #       precision to give an estimate of the error, in
                    #       degrees. The error is then divided by 360 to convert
                    #       it to a fraction around a circle. Assuming the Earth
                    #       is a perfect sphere then the fraction can be
                    #       converted to a distance around its circumference.
