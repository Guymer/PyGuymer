...
#                                                                                            #
# https://github.com/Guymer/PyGuymer3/blob/master/MPLS/load_PlayItem.py                      #
##############################################################################################
...
def load_PlayItem(fobj, length2):
    ...
    ans[u"ClipInformationFileName"] = fobj.read(5);                                                                     length2 += 5; length2a += 5
    ans[u"ClipCodecIdentifier"] = fobj.read(4);                                                                         length2 += 4; length2a += 4
