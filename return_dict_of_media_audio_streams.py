                        ...
                        for AudioStreamEntry in PlayItem[u"STNTable"][name]:
                            ...
                            if u"StreamEntry" in AudioStreamEntry and u"StreamAttributes" in AudioStreamEntry:
                                ...
                                if u"RefToStreamPID" in AudioStreamEntry[u"StreamEntry"] and u"LanguageCode" in AudioStreamEntry[u"StreamAttributes"]:
                                    # Check that FFPROBE also found the stream ...
                                    if AudioStreamEntry[u"StreamEntry"][u"RefToStreamPID"] in ans:
                                        # Add language code to the stream information ...
                                        ans[AudioStreamEntry[u"StreamEntry"][u"RefToStreamPID"]][u"langcode"] = AudioStreamEntry[u"StreamAttributes"][u"LanguageCode"]
